...
source build.env
echo "======================================================="
echo "  EMERGENCY Cooker — [3/5] Firmware RE-ENFORCED (ALSA) "
echo "	Drop the Firmware in /firmware/firmware.tar.gz       "
echo "======================================================="
echo ">>> Device:  $DEVICE_NAME"
echo ">>> Release: $UBUNTU_RELEASE"
echo ">>> RootFS:  $ROOTFS_DIR"

read -p "If the firmware is ready and in-place, press any key... " -n1 -s
...
# ------- 9b. Re-apply local firmware archive (wins over apt) (disabled,only for developers)-------
