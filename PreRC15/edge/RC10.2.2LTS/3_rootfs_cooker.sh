...
source build.env
echo "======================================================="
echo "   Mobuntu — [3/5] RootFS Cooker -- RC10.2.1"
echo "======================================================="
...
# RC10.2.1: No pmaports device files
...
# ------- Cleanup -------
rm -rf /tmp/kernel_payload /tmp/firmware.tar.gz /tmp/zz-qcom-bootimg /tmp/bootimg-initrd-hook /tmp/qcom-firmware /tmp/51-qcom.conf /tmp/82-beryllium-remoteproc.rules /tmp/remoteproc-adsp-trigger.sh
apt-get clean
