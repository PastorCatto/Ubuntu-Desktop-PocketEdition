...
source build.env
echo "======================================================="
echo "   Mobuntu Orange — [4/5] Enter Chroot (Debug)"
echo "======================================================="

# WSL2 ARM64 binfmt injection
...
if [ ! -f /usr/bin/qemu-aarch64-static ]; then
    echo "ERROR: qemu-user-static not installed on host."
    exit 1
fi
...
echo ">>> Entering chroot ($ROOTFS_DIR)..."
